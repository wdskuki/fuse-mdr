#include "coding_raid6_noRotate.hh"
 ...
 */
 Coding4Raid6noRotate::Coding4Raid6noRotate(){
 ...
 */
 ...
 int Coding4Raid6noRotate::gf_gen_tables(int s)
 {
 ...
 */
 ...
 unsigned short Coding4Raid6noRotate::gf_mul(int a, int b, int s)
 {
 ...
 */
 ...
 unsigned short Coding4Raid6noRotate::gf_div(int a, int b, int s)
 {
 	unsigned int field_max;
 	int diff;
 	unsigned short result;
 ...
 */
 ...
 int Coding4Raid6noRotate::gf_get_coefficient(int value, int s)
 {
 	int result;
 ...
 */
struct data_block_info Coding4Raid6noRotate::encode(const char* buf, int size)
{
	...
	if (disk_id == -1) {
		...
		// Cache Start
		retstat =
			cacheLayer->writeDisk(parity_disk_id, buf2, size,
					block_no * block_size);
		retstat =
			cacheLayer->writeDisk(code_disk_id, buf3, size,
					block_no * block_size);
		// Cache End
 ...
 */
int Coding4Raid6noRotate::decode(int disk_id, char* buf, long long size, long long offset)
{
	int retstat;
	char* temp_buf;
	int i;
 ...
 */
 int Coding4Raid6noRotate::recover(int failed_disk_id,char* newdevice)
 {
 ...
 int Coding4Raid6noRotate::recover_enable_node_encode(int failed_disk_id, char* newdevice, int* node_socketid_array)
 {

 	return 0;
 }

 int Coding4Raid6noRotate::recover_using_multi_threads_nor(int failed_disk_id, char* newdevice, int total_sor_threads){

 	return 0;
 }

 int Coding4Raid6noRotate::recover_using_multi_threads_sor(int failed_disk_id, char* newdevice
 	, int total_sor_threads, int number_sor_thread){

 	return 0;
 }

 int Coding4Raid6noRotate::recover_using_access_aggregation(int failed_disk_id, char* newdevice){

 	return 0;
 }

 int Coding4Raid6noRotate::recover_conventional(int failed_disk_id, char* newdevice){
